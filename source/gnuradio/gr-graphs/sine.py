...
class sine(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.vlc_board_interface_b_0 = vlc.board_interface_bb('192.168.1.23', 7777, 6666, 256)
        ...
        self.blocks_vco_f_0 = blocks.vco_f(32, 2*pi, 1)
        self.blocks_unpack_k_bits_bb_0 = blocks.unpack_k_bits_bb(8)
        self.blocks_uchar_to_float_1 = blocks.uchar_to_float()
        self.blocks_uchar_to_float_0 = blocks.uchar_to_float()
        self.blocks_repeat_0 = blocks.repeat(gr.sizeof_float*1, 32)
        ...
        self.connect((self.blocks_add_const_vxx_2, 0), (self.blocks_repeat_0, 0))
        ...
        self.connect((self.blocks_uchar_to_float_1, 0), (self.blocks_add_const_vxx_2, 0))
        self.connect((self.blocks_unpack_k_bits_bb_0, 0), (self.blocks_uchar_to_float_1, 0))
        self.connect((self.blocks_vco_f_0, 0), (self.blocks_add_const_vxx_0, 0))
        self.connect((self.vlc_board_interface_b_0, 0), (self.blocks_uchar_to_float_0, 0))
        self.connect((self.vlc_nic_interface_b_0, 0), (self.blocks_unpack_k_bits_bb_0, 0))
